...
- **[implement-issue](./skills/engineering/implement-issue/SKILL.md)** — Implement a GitHub issue end-to-end using TDD, following the Agent Brief contract.
- **[triage](./skills/engineering/triage/SKILL.md)** — Triage issues through a state machine of triage roles.
- **[improve-codebase-architecture](./skills/engineering/improve-codebase-architecture/SKILL.md)** — Find deepening opportunities in a codebase, informed by the domain language in `CONTEXT.md` and the decisions in `docs/adr/`.
- **[parallel-issue-runner](./skills/engineering/parallel-issue-runner/SKILL.md)** — Launch parallel sub-agents in git worktrees to implement all triaged child issues of a PRD, looping until the PRD is complete.
